...
if stop_2_outing == 'timeout':
    print('exitting because of timeout')
    exit()
#time.sleep(12.5 + abs(np.random.normal(0,.7)))
...
if stop_3_outing == 'timeout':
    print('exitting because of timeout')
    exit()
#time.sleep(10.6 + abs(np.random.normal(0,.4)))
...
if stop_4_outing == 'timeout':
    print('exitting because of timeout')
    exit()
#time.sleep(10 + abs(np.random.normal(0,.8)))
#measured 11.5s walking
...
if boat_outing == 'timeout':
    print('exitting because of timeout')
    exit()
#time.sleep(8.7 + abs(np.random.normal(0,.5)))
#measured 9.23s. 
...
key_press('1')
#time.sleep(3 + abs(np.random.normal(0,.8)))
#measured 4.09
